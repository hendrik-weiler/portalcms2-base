...
<head>
	...
	<?php
		...
		print $asset->from_component('interactive.contextmenu.js','helper');
		print $asset->from_component('interactive.load.js','helper');
...
<body>
	...
	var interactive = new pcms2.interactive.load();
	</script>
</body>
</html>